...
# ggplot(dfMM,aes(time,y,group=interaction(treatment,sample)))+
...
# print(load("getGrowthModelOutputs/growthModelOutput_logistic.rdata"))
# growthModelOutput_logistic
# 
# print(load("getGrowthModelOutputs/growthModelOutput_from_df_monomolecular.rdata"))
# growthModelOutput_from_df_monomolecular
# 
# ggplot(growthModelOutput_from_df_monomolecular[1][[1]])+
#   geom_col(aes(x=model, y=loo_IC, fill=model))+
#   geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
#   geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
#   geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
...
#             axis.text.x.bottom = element_blank())
# 
# print(load("getGrowthModelOutputs/growthModelOutput_from_df_Linear.rdata"))
# growthModelOutput_from_df_Linear
# 
# print(load("getGrowthModel_fastTest.rdata"))
# test
...
print(load("getGrowthModelOutputs/growthModelOutput_from_df_exponential.rdata"))

growthModelOutput_from_df_exponential[1]
ggplot(growthModelOutput_from_df_exponential[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
  ...
  theme(axis.line.y.left = element_line(),
            axis.line.x.bottom = element_line(),
            axis.text.x.bottom = element_blank())
growthModelOutput_from_df_exponential[5]


print(load("getGrowthModelOutputs/growthModelOutput_from_df_gompertz.rdata"))

growthModelOutput_from_df_gompertz[1]
ggplot(growthModelOutput_from_df_gompertz[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
  ...
  theme(axis.line.y.left = element_line(),
        axis.line.x.bottom = element_line(),
        axis.text.x.bottom = element_blank())
growthModelOutput_from_df_gompertz[5]


print(load("getGrowthModelOutputs/growthModelOutput_from_df_Linear.rdata"))

growthModelOutput_from_df_Linear[1]
ggplot(growthModelOutput_from_df_Linear[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
  ...
  theme(axis.line.y.left = element_line(),
        axis.line.x.bottom = element_line(),
        axis.text.x.bottom = element_blank())
growthModelOutput_from_df_Linear[5]



print(load("getGrowthModelOutputs/growthModelOutput_from_df_logistic.rdata"))
growthModelOutput_from_df_logistic[1]
ggplot(growthModelOutput_from_df_logistic[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
  ...
  theme(axis.line.y.left = element_line(),
        axis.line.x.bottom = element_line(),
        axis.text.x.bottom = element_blank())
growthModelOutput_from_df_logistic[5]

print(load("getGrowthModelOutputs/growthModelOutput_from_df_monomolecular.rdata"))
growthModelOutput_from_df_monomolecular[1]
ggplot(growthModelOutput_from_df_monomolecular[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  ...
  theme(axis.line.y.left = element_line(),
        axis.line.x.bottom = element_line(),
        axis.text.x.bottom = element_blank())
growthModelOutput_from_df_monomolecular[5]


print(load("getGrowthModelOutputs/growthModelOutput_from_df_powerLaw.rdata"))

growthModelOutput_from_df_powerLaw[1]
ggplot(growthModelOutput_from_df_powerLaw[1][[1]])+
  geom_col(aes(x=model, y=loo_IC, fill=model))+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC+loo_IC_se), size = 1.5)+
  geom_segment(aes(x=model, xend=model, y=loo_IC, yend = loo_IC-loo_IC_se), size = 1.5)+
  geom_text(aes(x=model, y=loo_IC*1.05, label = paste0(round(loo_IC, digits=0))))+
  ...
  theme(axis.line.y.left = element_line(),
        axis.line.x.bottom = element_line(),
        axis.text.x.bottom = element_blank())
growthModelOutput_from_df_powerLaw[5]
